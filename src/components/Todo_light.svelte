...
<div class="flex flex-grow items-center justify-center h-full text-gray-600 bg-gray-100">
    <!-- Component Start -->
    <div class="max-w-full p-8 bg-white rounded-lg shadow-lg w-96 text-gray-700">
        ...
        {#each todoContents as todoContent (todoContent.id)}
        <div class="py-1">
        ...
        <div class="flex items-center w-full h-8 px-2 mt-2 text-sm font-medium rounded bg-gray-100">
            <button class="border-none outline-none active:bg-gray-500" on:click={sendDataToApp}>
